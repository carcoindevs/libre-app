  ...
  return (
    <Svg viewBox="0 0 32 64" {...props}>
      ...
      <path
        ...
        fill="#5E38AA"
      />
      <path d="M16.0151 46.2002C14.9409 55.689 22.4506 64 32 64V18L20 11L16.0151 46.2002Z" fill="#333FFF" />
      <path
        d="M25 18C22.2386 18 20 15.7614 20 13C20 10.2386 22.2386 8 25 8H26C27 8 30 7 30 5V8C30 14.5 28 18 28 18H25Z"
        fill="#4E2F8C"
      />
      <path fillRule="evenodd" clipRule="evenodd" d="M27 18H20V11C20 14.866 23.134 18 27 18Z" fill="#333FFF" />
      <path
