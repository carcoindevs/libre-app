...
import { Heading, Card, CardBody, Button, useModal } from '@tiscotservices/forkeduikitforlibreind'
    ...
    if (!allowance.toNumber()) {
      return (
        <Button width="100%" disabled={requestedApproval} onClick={handleApprove}>
          {TranslateString(494, 'Approve LIBRE')}
        </Button>
      )
    }
    return (
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <Block>
          <Label>{TranslateString(552, 'LIBRE to Collect')}:</Label>
