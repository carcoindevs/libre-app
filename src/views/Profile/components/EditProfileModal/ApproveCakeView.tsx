...
import { AutoRenewIcon, Button, Flex, InjectedModalProps, Text } from '@tiscotservices/carpooluikit'
  ...
  return (
    <Flex flexDirection="column">
      <Flex alignItems="center" justifyContent="space-between" mb="24px">
        ...
        <Text>{TranslateString(999, `${getFullDisplayBalance(cost)} CPool`)}</Text>
      </Flex>
      <Button
