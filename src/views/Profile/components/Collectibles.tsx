  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'CPool Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'Pancake Collectibles are special ERC-721 NFTs that can be used on the CPool platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved CPool Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved CPool Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
