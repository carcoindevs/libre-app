...
import { Modal, ModalBody, Text, Image, Button, Link, OpenNewIcon } from '@tiscotservices/forkeduikitforlibreind'
    ...
    <Modal title="LP Tokens required" onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        ...
        <Button
          as={Link}
          external
          href={`${BASE_ADD_LIQUIDITY_URL}/BNB/0x51bd7298d99178a30eeedc9c7d60ac6415685617`}
